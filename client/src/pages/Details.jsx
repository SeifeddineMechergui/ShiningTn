...
const Details = () => {
    ...
    // Increment function for quantity, with stock check
    const inc = () => {
    ...
    // Decrement function for quantity, with a minimum check of 1
    const dec = () => {
        if (quantity > 1) {
            setQuantity(quantity - 1);
        }
    ...
    // Buy Now function, with stock check
    const buy = () => {
        if (product.stock === 0) {
    ...
    return (
        <div>
            <Headers />
            <div className='bg-[url("https://shining-tn.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                    <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                        <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
                            <h2 className='text-3xl font-bold'>Shining</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex py-5 gap-5'>
                                ...
                                <div className='flex flex-col gap-5'>
                                <span className={`text-${product.stock === 0 ? 'red' : product.stock <= 10 ? 'green' : 'blue'}-500`}>
                               {product.stock === 0 ? 'Out of Stock' : (product.stock <= 10 ? `In Stock (${product.stock})` : 'In Stock')}
                               </span>
                            ...
                            <div className='flex gap-3'>
                                {
                                    product.stock ? <>
                                        <button onClick={buy} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-purple-500/40 bg-purple-500 text-white'>Buy Now</button>
