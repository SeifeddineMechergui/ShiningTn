...
const Shipping = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("https://shining-tn.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                                ...
                                <div className="bg-white p-6 shadow-sm rounded-md">
                                    ...
                                    }
                                    {
                                        res && <div className='flex flex-col gap-1'>
                                            ...
                                            <p className='text-slate-600 text-sm'>Email to mechergui.seifeddine@yahoo.com</p>
                                        </div>
                                    }
                                </div>
                                {
