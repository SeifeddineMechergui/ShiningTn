                            ...
                            <table className='w-full text-sm text-left text-[#d0d2d6]'>
                                <thead className='text-sm text-[#d0d2d6] uppercase border-b border-slate-700'>
                                    <tr>
                                        ...
                                        <th scope='col' className='py-3 px-4'>Sub Category</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {
                        ...
                        <div className='bg-[#283046] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
                            ...
                            <form onSubmit={add_category}>
                                ...
                                <div className='flex flex-col w-full gap-1 mb-3'>
                                    ...
                                    <input 
                                        value={state.subCat} 
                                        onChange={(e) => setState({ ...state, subCat: e.target.value })} 
                                        className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' 
                                        type="text" 
                                        id='subCat' 
                                        name='subCat' 
                                ...
                                <div className='mt-4'>
                                    <button disabled={loader} className='bg-blue-500 w-full hover:shadow-blue-500/20 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
