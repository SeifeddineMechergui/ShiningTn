...
export const add_product = createAsyncThunk(
    ...
    async (product, { rejectWithValue, fulfillWithValue ,getState}) => {
        ...
        try {
            const { data } = await api.post('/product-add', product, config)
...
export const update_product = createAsyncThunk(
    ...
    async (product, { rejectWithValue, fulfillWithValue,getState }) => {
        ...
        try {
            const { data } = await api.post('/product-update', product, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const product_image_update = createAsyncThunk(
    ...
    async ({ oldImage, newImage, productId }, { rejectWithValue, fulfillWithValue ,getState}) => {
        ...
        try {
            ...
            const { data } = await api.post('/product-image-update', formData, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_products = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue,getState }) => {
        ...
        try {
            const { data } = await api.get(`/products-get?page=${page}&&searchValue=${searchValue}&&parPage=${parPage}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_product = createAsyncThunk(
    ...
    async (productId, { rejectWithValue, fulfillWithValue,getState }) => {
        ...
        try {
            const { data } = await api.get(`/product-get/${productId}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
