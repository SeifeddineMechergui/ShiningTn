...
export const seller_login = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue }) => {
        try {
            const { data } = await api.post('/api/seller-login', info, { withCredentials: true })
            localStorage.setItem('accessToken', data.token)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
...
export const seller_register = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue }) => {
        try {
            console.log(info)
            const { data } = await api.post('/api/seller-register', info, { withCredentials: true })
            localStorage.setItem('accessToken', data.token)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
...
export const profile_image_upload = createAsyncThunk(
    ...
    async (image, { rejectWithValue, fulfillWithValue }) => {
        try {
            const { data } = await api.post('/api/profile-image-upload', image, { withCredentials: true })
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const profile_info_add = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue }) => {
        try {
            const { data } = await api.post('/api/profile-info-add', info, { withCredentials: true })
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_user_info = createAsyncThunk(
    ...
    async (_, { rejectWithValue, fulfillWithValue }) => {
        try {
            const { data } = await api.get('/api/get-user', { withCredentials: true })
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
